    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          {t.whyUs.description && (
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-6">{t.whyUs.description}</p>
          )}
        </div>
          ...
          {t.whyUs.reasons.map((point, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-lg font-bold text-white mb-2">{point.title}</span>
                {point.description && (
                  <p className="text-gray-300 text-base mt-1">{point.description}</p>
                )}
              </div>
            );
          })}
